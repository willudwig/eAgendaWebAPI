    ...
    public class Compromisso : EntidadeBase<Compromisso>
    {
        ...
        public TipoLocalizacaoCompromissoEnum TipoLocal
        {
            ...
            set
            {
                ...
                {
                    case TipoLocalizacaoCompromissoEnum.Presencial: 
                        Link = null; 
                        break;
                    case TipoLocalizacaoCompromissoEnum.Remoto: 
                        Local = null; 
                        break;
        ...
        public static explicit operator Compromisso(eAgenda.Webapi.ViewModels.ModuloContato.FormsContatoViewModel v)
        {
